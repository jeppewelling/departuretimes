(function($){
    ...
    var ListView = Backbone.View.extend({
        ...
        initialize: function(){
            ...
            this.departures = new List();
            this.departures.comparator = 'DepartureTime';


            this.departures.bind('reset', this.resetDepartures);
        ...
        render: function(){
            ...
            _(this.departures.models).each(function(departure){
	...
	renderDepartures: function() {
	    ...
	    this.departures.forEach(function(departure, i, lst) {
